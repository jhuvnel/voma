function varargout = seg_data_v3(varargin)
% SEG_DATA_V3 MATLAB code for seg_data_v3.fig
%      SEG_DATA_V3, by itself, creates a new SEG_DATA_V3 or raises the existing
%      singleton*.
%
%      H = SEG_DATA_V3 returns the handle to a new SEG_DATA_V3 or the handle to
%      the existing singleton*.
%
%      SEG_DATA_V3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEG_DATA_V3.M with the given input arguments.
%
%      SEG_DATA_V3('Property','Value',...) creates a new SEG_DATA_V3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before seg_data_v3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to seg_data_v3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help seg_data_v3

% Last Modified by GUIDE v2.5 13-Oct-2016 19:46:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @seg_data_v3_OpeningFcn, ...
                   'gui_OutputFcn',  @seg_data_v3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before seg_data_v3 is made visible.
function seg_data_v3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to seg_data_v3 (see VARARGIN)

% Choose default command line output for seg_data_v3
...
% UIWAIT makes seg_data_v3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = seg_data_v3_OutputFcn(hObject, eventdata, handles) 

function varargout = Monkey_Voma_Processing_V2(varargin)
% MONKEY_VOMA_PROCESSING_V2 MATLAB code for Monkey_Voma_Processing_V2.fig
%      MONKEY_VOMA_PROCESSING_V2, by itself, creates a new MONKEY_VOMA_PROCESSING_V2 or raises the existing
%      singleton*.
%
%      H = MONKEY_VOMA_PROCESSING_V2 returns the handle to a new MONKEY_VOMA_PROCESSING_V2 or the handle to
%      the existing singleton*.
%
%      MONKEY_VOMA_PROCESSING_V2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MONKEY_VOMA_PROCESSING_V2.M with the given input arguments.
%
%      MONKEY_VOMA_PROCESSING_V2('Property','Value',...) creates a new MONKEY_VOMA_PROCESSING_V2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Monkey_Voma_Processing_V2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Monkey_Voma_Processing_V2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Monkey_Voma_Processing_V2
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @Monkey_Voma_Processing_V2_OpeningFcn, ...
    'gui_OutputFcn',  @Monkey_Voma_Processing_V2_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before Monkey_Voma_Processing_V2 is made visible.
function Monkey_Voma_Processing_V2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Monkey_Voma_Processing_V2 (see VARARGIN)

% Choose default command line output for Monkey_Voma_Processing_V2
...
% UIWAIT makes Monkey_Voma_Processing_V2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);
end

% --- Outputs from this function are returned to the command line.
function varargout = Monkey_Voma_Processing_V2_OutputFcn(hObject, eventdata, handles)
